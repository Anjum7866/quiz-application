...
<head>
    ...
    <!-- Template Stylesheet -->
    <link href="{{ asset('assets/css/stylelms.css')}}" rel="stylesheet">
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0" style="height:50px">
        <a href="index.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary">TecnolynxGlobal</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="/register" class="btn btn-primary py-2 px-lg-5 d-none d-lg-block">Join Now<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </nav>
    <!-- Navbar End -->
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4">Welcome to TecnolynxGlobal</h1>
            ...
            @foreach($subjects as $key => $subject)    
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item bg-light">
                        ...
                        <img class="img-fluid" style="width:100%; height:300px" src="{{asset('assets/uploads/profile/'.$subject->image_path)}}" alt="">
            ...
            @foreach ($teachers as $teacher)
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        ...
                        <img src="{{asset('assets/uploads/profile/'.$teacher->profile->avatar)}}"class="img-fluid" alt="avatar" style="height: 300px;width: 100%;">
                            @else
                            <img class="img-fluid" src="{{ asset('assets/img/team-1.jpg')}}" alt="" style="height: 300px;width: 100%;">
                        @endif
                        </div>
                        <div class="position-relative d-flex justify-content-center" style="margin-top: -23px;">
                            <div class="bg-light d-flex justify-content-center pt-2 px-1">
                                @if($teacher->profile->facebook_url)
                                <a class="btn btn-sm-square btn-primary mx-1" href="{{$teacher->profile->facebook_url}}"><i class="fab fa-facebook-f"></i></a>
                                @else
                                <a class="btn btn-sm-square btn-primary mx-1" href="www.fb.com"><i class="fab fa-facebook-f"></i></a>
                                @endif
                                @if($teacher->profile->facebook_url)
                                <a class="btn btn-sm-square btn-primary mx-1" href="{{$teacher->profile->twitter_url}}"><i class="fab fa-twitter"></i></a>
                                @else
                                <a class="btn btn-sm-square btn-primary mx-1" href="www.twitter.com"><i class="fab fa-twitter"></i></a>
                                @endif
                                @if($teacher->profile->facebook_url)
                                <a class="btn btn-sm-square btn-primary mx-1" href="{{$teacher->profile->instagram_url}}"><i class="fab fa-instagram"></i></a>
                                @else
                                <a class="btn btn-sm-square btn-primary mx-1" href="www.instagram.com"><i class="fab fa-instagram"></i></a>
                                @endif
                            </div>
                        </div>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">www.tecnolynxglobal.com</a>, All Right Reserved.
                    </div>
